  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View>
        ...
        >
          {profileSlice?.images?.length>0&&profileSlice.images.map((img, index) => (
            <Image
              key={index}
              source={{uri:img?img:"https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y"}}
              style={styles.image}
              resizeMode="cover"
            />
          ))}
        ...
        <View style={styles.dotsContainer}>
          {user?.images?.length>0&& user.images.map((_, index) => (
            <View
              key={index}
              style={[
                styles.dot,
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.topRow}>
          ...
          <TouchableOpacity onPress={() => router.push('Editloginuser')}>
