...
const Searchuser = () => {
  ...
  }, [profileSlice?.id, filterage, filterdistance, genderfilter, filterintrests, filtercetagory]);
  ...
  useEffect(() => {
    if (profileSlice?.id && (filterage !== undefined || filterdistance !== undefined || genderfilter !== undefined || filterintrests !== undefined || filtercetagory !== undefined)) {
      loadProfiles(1, true);
    }
  }, [filterage, filterdistance, genderfilter, filterintrests, filtercetagory]);
